...
int main()
{
	Mat img = imread("D:/images/airplane.jpg");
	if (img.empty())
	{
	...
	//读取分类种类名称
	String typeListFile = "D:/images/imagenet_comp_graph_label_strings.txt";
	...
	// 加载网络
	String tf_pb_file = "D:/images/tensorflow_inception_graph.pb";
